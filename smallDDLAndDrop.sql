drop table prereq_s;
drop table time_slot_s;
drop table advisor_s;
drop table takes_s;
drop table student_s;
drop table teaches_s;
drop table section_s;
drop table instructor_s;
drop table course_s;
drop table department_s;
drop table classroom_s;

create table classroom_s
	(building		varchar(15),
...
create table advisor_s
	(s_ID			varchar(5),
	 i_ID			varchar(5),
	 primary key (s_ID),
	 foreign key (i_ID) references instructor_s (ID)
		on delete set null,
	 foreign key (s_ID) references student_s (ID)
		on delete cascade
	);

create table time_slot_s
	(time_slot_id		varchar(4),
	 day			varchar(1),
